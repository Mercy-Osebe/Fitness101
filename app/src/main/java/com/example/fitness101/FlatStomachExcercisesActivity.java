...
public class FlatStomachExcercisesActivity extends AppCompatActivity {
    //the button clicked value represents the layout id that was clicked on.
    //this helps to render different views.
